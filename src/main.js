...
var main = (function(){
    ...
    var init = function(){
        chrome.storage.sync.get('loc', function(data){
            ...
            getData('currentWeatherData', 'http://api.openweathermap.org/data/2.5/weather?id=' + LOCATION.id + '&APPID=4b6ca5f33e7940228aef1c03a4153bed', weatherData, 0, parseAndRender);
            getData('todayWeatherData', 'http://api.openweathermap.org/data/2.5/forecast?id=' + LOCATION.id + '&APPID=4b6ca5f33e7940228aef1c03a4153bed', weatherData, 1, parseAndRender);
            getData('forecastWeatherData', 'http://api.openweathermap.org/data/2.5/forecast/daily?id=' + LOCATION.id + '&APPID=4b6ca5f33e7940228aef1c03a4153bed', weatherData, 2, parseAndRender);
